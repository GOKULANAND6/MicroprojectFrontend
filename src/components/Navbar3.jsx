...
function Navbar3() {
  ...
  useEffect(() => {
    ...
    if (customerData) {
      ...
      setData(parsedCustomerData.customer_id)
      console.log(parsedCustomerData.customer_id)
    }
  }, []);
    ...
    <div>
      ...
      <nav className="navbar bg-white bg-opacity-80 rounded-b-lg shadow-md p-2">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-4 items-center">
            <Link to="/viewcustomerdetails"><a className="text-gray-800 hover:text-blue-500 font-bold">
              View Customer Detail
            </a>
            </Link>

            <Link to="/processclaim"><a  className="text-gray-800 hover:text-blue-500 font-bold">
              Process the Claim
            </a>
            </Link>
            <Link to="/viewclaim4"><a  className="text-gray-800 hover:text-blue-500 font-bold">
              Settle Amount
            </a>
            </Link>

            <Link to="/viewclaim"><i class='fas fa-bell' id="fafa"></i></Link>
      ...
      >
        <div className="bg-white rounded-lg shadow-lg max-w-sm w-full p-6 relative">
          ...
          <h2 className="text-xl font-semibold mb-4 text-center">Select Type</h2>
          <div className="flex flex-col space-y-4">
            <Link to="/fileclaim" className="block text-center text-blue-500 text-lg">
              File a Claim
            </Link>
            <Link to="/viewclaim2" className="block text-center text-blue-500 text-lg">
              Claim Status
            </Link>
            <Link to="/viewsettlement" className="block text-center text-blue-500 text-lg">
              Settlement Status
            </Link>
          </div>
        </div>
